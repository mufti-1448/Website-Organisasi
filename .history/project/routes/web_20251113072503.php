...
Route::get('/tentang-kami', fn() => view('user.tentang_kami.index'))->name('user.tentang_kami');

Route::resource('anggota', AnggotaController::class)->except(['show'])->name('user.anggota');
