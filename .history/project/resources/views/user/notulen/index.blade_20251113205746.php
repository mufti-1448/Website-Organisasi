                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        @if ($item->penulis->foto)
                                            <img src="{{ asset('storage/' . $item->penulis->foto) }}"
                                                alt="{{ $item->penulis->nama }}" class="rounded-circle me-2"
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-outline-primary"
                                        data-bs-toggle="modal" data-bs-target="#notulenModal{{ $item->id }}">
                        ...
                        <div class="modal-content border-0 shadow">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    {{ $item->rapat->tanggal ? \Carbon\Carbon::parse($item->rapat->tanggal)->translatedFormat('j F Y H:i') : 'Tidak tersedia' }}
                                </div>
