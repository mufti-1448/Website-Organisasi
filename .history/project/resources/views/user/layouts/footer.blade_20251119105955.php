    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex">
                    <a href="https://www.tiktok.com/@scoutsmksa?is_from_webapp=1&sender_device=pc" class="btn text-primary btn-lg p-0"><i class="bi bi-tiktok"></i></a>
                    <a href="https://www.instagram.com/scouts.smksa?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                        class="btn text-danger btn-lg p-0"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
        </div>
