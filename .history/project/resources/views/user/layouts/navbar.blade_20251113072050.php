    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav fw-medium">
                <li class="nav-item"><a class="nav-link active" href="{{ route('user.dashboard') }}"">Beranda</a></li>
                <li class="nav-item"><a class="nav-link" href="">Tentang</a></li>
                <li class="nav-item"><a class="nav-link" href="">Anggota</a></li>
                <li class="nav-item"><a class="nav-link" href="">Program</a></li>
                <li class="nav-item"><a class="nav-link" href="">Rapat</a></li>
                <li class="nav-item"><a class="nav-link" href="">Notulen</a></li>
                <li class="nav-item"><a class="nav-link" href="">Evaluasi</a></li>
