        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2"><a href="{{ route('user.kontak.index') }}"
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="small">
                    <p class="text-light mb-1"><strong>Senin - Jumat:</strong> 08:00 - 16:00</p>
                    <p class="text-light mb-1"><strong>Sabtu:</strong> 08:00 - 12:00</p>
                    <p class="text-light mb-0"><strong>Minggu:</strong> Tutup</p>
                </div>
                <div class="mt-3">
                    <a href="{{ route('user.kontak.index') }}" class="btn btn-primary btn-sm">
