            ...
            <div class="col-md-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    @if (isset($sosialMedia['instagram']) && $sosialMedia['instagram']->aktif)
                        <a href="{{ $sosialMedia['instagram']->url }}" class="btn btn-danger btn-sm rounded-circle"
                            target="_blank">
                            <i class="bi bi-instagram"></i>
                        </a>
                    @endif
                    @if (isset($sosialMedia['youtube']) && $sosialMedia['youtube']->aktif)
                        <a href="{{ $sosialMedia['youtube']->url }}" class="btn btn-danger btn-sm rounded-circle"
                            target="_blank">
                            <i class="bi bi-youtube"></i>
                        </a>
                    @endif
                    @if (isset($sosialMedia['tiktok']) && $sosialMedia['tiktok']->aktif)
                        <a href="{{ $sosialMedia['tiktok']->url }}" class="btn btn-dark btn-sm rounded-circle"
                            target="_blank">
