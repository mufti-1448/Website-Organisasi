                ...
                <div class="row g-4 justify-content-center">
                    @foreach ($anggota as $item)
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="org-card text-center shadow-sm p-4">
                                <img src="{{ $item->foto ? asset('storage/uploads/anggota/' . $item->foto) : asset('images/herosection/hero1.png') . $item->foto }}" class="org-img" alt="">
                                <h5 class="mt-3 mb-1"> M. Khafidhin Mufti Ali</h5>
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="org-card text-center shadow-sm p-4">
                            <img src="https://i.pravatar.cc/150?img=12" class="org-img" alt="">
                            <h5 class="mt-3 mb-1"> M. Khafidhin Mufti Ali</h5>
                            <small class="text-primary">Ketua</small>
                        </div>
                    </div>
