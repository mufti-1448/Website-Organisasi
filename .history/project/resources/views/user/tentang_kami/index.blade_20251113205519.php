    ...
    <div class="row mb-5">
        <div class="col-lg-6 mb-4">
            ...
            <p class="text-muted mb-3">
                Dewan Ambalan SMK Syafii Akrom adalah organisasi yang terdiri dari anggota-anggota terpilih yang berkomitmen 
            ...
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #198754;">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled text-muted small">
                        <li class="mb-2"><i class="bi bi-check2-circle text-success me-2"></i>Menyelenggarakan program-program berkualitas</li>
                        <li class="mb-2"><i class="bi bi-check2-circle text-success me-2"></i>Mengembangkan kepemimpinan anggota</li>
                        <li class="mb-2"><i class="bi bi-check2-circle text-success me-2"></i>Membangun kerjasama yang solid</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <p class="text-muted mb-4">Dewan Ambalan dipimpin oleh anggota-anggota terbaik yang terpilih melalui proses yang transparan dan demokratis.</p>
                    <div class="row">
