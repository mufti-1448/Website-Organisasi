    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-center">Ini adalah halaman Tentang Kami untuk pengguna umum.</p>
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <h3 class="card-title text-primary">Visi</h3>
                                <p class="card-text">Menjadi organisasi yang berkomitmen untuk mengembangkan potensi anggota
                                    dan berkontribusi positif bagi masyarakat.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text">Menyediakan platform untuk pengembangan keterampilan, networking, dan
                                    kontribusi sosial melalui berbagai program dan kegiatan.</p>
                            </div>
                        </div>
                    </div>
                </div>
