    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="position-relative">
                {{-- Gambar background --}}
                <img src="{{ asset('images/hero1.jpg') }}" class="d-block w-100" style="height: 90vh; object-fit: cover;" alt="Hero 1">

                {{-- Overlay biru transparan --}}
                <div class="position-absolute top-0 start-0 w-100 h-100" style="background-color: rgba(0, 45, 134, 0.65);"></div>

                {{-- Konten teks di tengah --}}
                <div class="position-absolute top-50 start-50 translate-middle text-white text-center px-4" style="max-width: 800px;">
                    <h1 class="fw-bold display-5">Website Organisasi <br> Dewan Ambalan</h1>
                    <p class="mt-3 mb-4">
                        Platform digital untuk mengelola dan mengembangkan kegiatan organisasi Dewan Ambalan dengan transparansi dan akuntabilitas yang tinggi.
                    </p>
        ...
        <div class="carousel-item">
            <div class="position-relative">
                <img src="{{ asset('images/hero2.jpg') }}" class="d-block w-100" style="height: 90vh; object-fit: cover;" alt="Hero 2">
                <div class="position-absolute top-0 start-0 w-100 h-100" style="background-color: rgba(0, 45, 134, 0.65);"></div>
                <div class="position-absolute top-50 start-50 translate-middle text-white text-center px-4" style="max-width: 800px;">
                    ...
                    <a href="{{ route('user.tentang_kami') }}" class="btn btn-light fw-semibold px-4 py-2">Pelajari Lebih Lanjut</a>
                </div>
            </div>
        </div>
