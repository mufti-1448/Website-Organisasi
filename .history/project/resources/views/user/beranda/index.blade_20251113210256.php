...
@section('content')
    <!-- Hero Section -->
    <section class=\"py-5\" style=\"background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); color: white; min-height:
        70vh; display: flex; align-items: center;\">
            ...
            <div class=\"row align-items-center\">
                <div class=\"col-lg-6\">
                    ...
                    <p class=\"fs-5 mb-4 opacity-90\">
                        Organisasi yang berkomitmen mengembangkan potensi anggota dan berkontribusi positif bagi kemajuan
