            ...
            <di class="row g-4">
                ...
                @forelse ($rapat as $data)
                    <div class="col-md-6 col-lg-4">
                        <div class="program-card shadow-lg" style="cursor: pointer;" onclick="window.location='{{ route('user.rapat.show', $data->id) }}'">
                        <div class="d-flex justify-content-between align-items-"></div>
                        </div>
                    </div>
            </di>
        </div>
