            ...
            <di class="row g-4">
                ...
                @forelse ($rapat as $data)
                    <div class="col-md-6 col-lg-4">
                        <div class="rapat-card" onclick="window.location='{{ route('user.rapat.show', $data->id) }}'">

                            <!-- Judul + Badge -->
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h5 class="rapat-title">{{ $data->judul }}</h5>
                            ...
                            <div class="rapat-footer mt-3">
                                @if ($data->status == 'selesai')
                                    <span class="btn-status-footer">Selesai</span>
                                @elseif($data->status == 'berlangsung')
                                    <span class="btn-status-footer"
                                        style="background:#fff4cc;color:#b88900;">Berlangsung</span>
                                @else
                                    <span class="btn-status-footer"
                                        style="background:#dce8ff;color:#0d42ff;">Direncanakan</span>
                                @endif
                            </div>
