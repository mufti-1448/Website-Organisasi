...
@section('title', 'Detail rapat Kerja')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $rapat->penanggungJawab->nama ?? '-' }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Target Date</label>
                                        <input type="date" class="form-control" value="{{ $rapat->target_date }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" rows="5" readonly>{{ $rapat->deskripsi ?? '-' }}</textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" class="form-control"
                                                value="{{ $rapat->notulen->waktu }}" readonly>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="tab-pane fade" id="evaluasi">
                                @if ($rapat->evaluasi)
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $rapat->evaluasi->judul }}"
                                            readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Isi Evaluasi</label>
                                        <textarea class="form-control" rows="5" readonly>{{ $rapat->evaluasi->isi }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="form-label">Tanggal</label>
                                            <input type="date" class="form-control"
                                                value="{{ $rapat->evaluasi->tanggal }}" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Penulis</label>
                                            <input type="text" class="form-control"
                                                value="{{ $rapat->evaluasi->penulisRelation->nama ?? $rapat->evaluasi->penulis }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">File</label>
                                            @if ($rapat->evaluasi->file)
                                                <br>
                                                <a href="{{ asset('storage/' . $rapat->evaluasi->file) }}"
                                ...
                                @else
                                    <p class="text-muted">Belum ada evaluasi untuk rapat kerja ini.</p>
                                @endif
                            </div>
                        </div>

                        <div class="mt-4">
                            <a href="{{ route('user.rapat_kerja.index') }}" class="back-btn">
