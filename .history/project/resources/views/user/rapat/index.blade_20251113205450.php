                ...
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100 hover-shadow">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <small class="text-muted d-block mb-1"><i class="bi bi-calendar-event me-1"></i><strong>Tanggal:</strong></small>
                                <p class="small">{{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('j F Y H:i') }}</p>
                            </div>

                            <div class="mb-3">
                                <small class="text-muted d-block mb-1"><i class="bi bi-geo-alt-fill me-1"></i><strong>Tempat:</strong></small>
                                <p class="small">{{ $item->tempat }}</p>
                            </div>

                            <div class="mb-3">
                                <small class="text-muted d-block mb-1"><i class="bi bi-bookmark-fill me-1"></i><strong>Agenda:</strong></small>
                                <p class="small">{{ $item->agenda ?: 'Tidak ada keterangan' }}</p>
                            </div>

                            @if($item->catatan)
                                <div>
                                    <small class="text-muted d-block mb-1"><i class="bi bi-file-text me-1"></i><strong>Catatan:</strong></small>
