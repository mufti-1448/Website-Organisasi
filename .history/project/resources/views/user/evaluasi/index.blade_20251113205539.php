                ...
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100 hover-shadow">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <small class="text-muted d-block mb-1"><i class="bi bi-calendar-event me-1"></i><strong>Tanggal Evaluasi:</strong></small>
                                <p class="small mb-0">{{ \Carbon\Carbon::parse($item->tanggal_evaluasi)->translatedFormat('j F Y') }}</p>
                            </div>
                            ...
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar" role="progressbar" style="width: {{ $item->nilai ?? 0 }}%" aria-valuenow="{{ $item->nilai ?? 0 }}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
