                            ...
                            <div class="tab-pane fade show active" id="detail">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $evaluasi->penulis->nama }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control" value="{{ $evaluasi->waktu }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Rapat Terkait</label>
                                        <input type="text" class="form-control"
                                            value="{{ $evaluasi->rapat->judul ?? 'Tidak ada rapat terkait' }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">File</label>
                                        @if ($evaluasi->file_path)
                                            <br>
                                            <a href="{{ asset('storage/' . $evaluasi->file_path) }}" target="_blank"
