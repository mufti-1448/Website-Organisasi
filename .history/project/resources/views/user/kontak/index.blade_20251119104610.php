                    ...
                    <div class="card-body">
                        <form method="post" action="#" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="subject" placeholder="Subjek pesan"
                                    required>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-lg-7">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-body d-flex flex-column justify-content-center align-items-start">
                            ...
                            <p class="text-muted">Untuk kecepatan, silakan hubungi kami langsung melalui email atau telepon di samping. Kami akan merespon secepatnya.</p>

                            <div class="mt-3">
                                <a href="mailto:info@organisasi.com" class="btn btn-primary me-2">
                                    <i class="bi bi-envelope-fill me-1"></i> Kirim Email
                                </a>
                                <a href="tel:+62211234567" class="btn btn-outline-secondary">
                                    <i class="bi bi-telephone-fill me-1"></i> Hubungi via Telepon
                                </a>
                            </div>

                            <small class="text-muted mt-4">Atau kunjungi kantor kami pada jam kerja jika perlu bertemu langsung.</small>
                        </div>
                    </div>
                </div>
        </div>
