                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border-0 bg-light" id="nama" name="nama" required placeholder="Masukkan nama Anda">
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control border-0 bg-light" id="email" name="email" required placeholder="Masukkan email Anda">
                        </div>

                        <div class="mb-3">
                            <label for="telepon" class="form-label">Telepon</label>
                            <input type="tel" class="form-control border-0 bg-light" id="telepon" name="telepon" placeholder="Masukkan nomor telepon">
                        </div>

                        <div class="mb-3">
                            <label for="subjek" class="form-label">Subjek</label>
                            <input type="text" class="form-control border-0 bg-light" id="subjek" name="subjek" required placeholder="Subjek pesan Anda">
                        </div>

                        <div class="mb-3">
                            <label for="pesan" class="form-label">Pesan</label>
                            <textarea class="form-control border-0 bg-light" id="pesan" name="pesan" rows="5" required placeholder="Ketik pesan Anda di sini..."></textarea>
                        </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-0">
                    ...
                    <div style="width: 100%; height: 400px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 0 0 0.25rem 0.25rem;">
