            ...
            <div class="col-lg-7">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex flex-column justify-content-center align-items-start">
                        ...
                        <p class="text-muted">Untuk kecepatan, silakan hubungi kami langsung melalui email atau telepon di
                            samping. Kami akan merespon secepatnya.</p>
                        ...
                        <small class="text-muted mt-4">Atau kunjungi kantor kami pada jam kerja jika perlu bertemu
                            langsung.</small>
                    </div>
                </div>
            </div>
