                    ...
                    <div class="detail-card">
                        ...
                        <div class="info-section">
                            ...
                            <p class="info-value">
                                ...
                                {{ $programKerja->penanggungJawab->nama ?? 'Tidak ada' }}
                            </p>
                        </div>
                        ...
                        @if ($programKerja->tanggal_mulai)
                            <div class="info-section">
                                ...
                                <p class="info-value">
                                    ...
                                    {{ \Carbon\Carbon::parse($programKerja->tanggal_mulai)->format('d F Y') }}
                                </p>
                            </div>
                        @endif
                        ...
                        @if ($programKerja->tanggal_selesai)
                            <div class="info-section">
                                ...
                                <p class="info-value">
                                    ...
                                    {{ \Carbon\Carbon::parse($programKerja->tanggal_selesai)->format('d F Y') }}
                                </p>
                            </div>
                        @endif

                        <!-- Anggaran -->
                        @if ($programKerja->anggaran)
                            <div class="info-section">
                        ...
                        @if ($programKerja->target_peserta)
                            <div class="info-section">
                                ...
                                <p class="info-value">
                                    ...
                                    {{ $programKerja->target_peserta }} orang
                                </p>
                            </div>
                        @endif

                        <!-- Kriteria Peserta -->
                        @if ($programKerja->kriteria_peserta)
                            <div class="info-section">
                                <h5 class="info-label">Kriteria Peserta</h5>
                                <p class="info-value">{{ $programKerja->kriteria_peserta }}</p>
                            </div>
                        @endif

                        <!-- Indikator Keberhasilan -->
                        @if ($programKerja->indikator_keberhasilan)
                            <div class="info-section">
                                <h5 class="info-label">Indikator Keberhasilan</h5>
                                <p class="info-value">{{ $programKerja->indikator_keberhasilan }}</p>
                            </div>
                        @endif

                        <!-- Sasaran -->
                        @if ($programKerja->sasaran)
                            <div class="info-section">
                                <h5 class="info-label">Sasaran</h5>
                                <p class="info-value">{{ $programKerja->sasaran }}</p>
                            </div>
                        @endif

                        <!-- Tujuan -->
                        @if ($programKerja->tujuan)
                            <div class="info-section">
                                <h5 class="info-label">Tujuan</h5>
                                <p class="info-value">{{ $programKerja->tujuan }}</p>
                            </div>
                        @endif

                        <!-- Manfaat -->
                        @if ($programKerja->manfaat)
                            <div class="info-section">
                                <h5 class="info-label">Manfaat</h5>
                                <p class="info-value">{{ $programKerja->manfaat }}</p>
                            </div>
                        @endif
                        ...
                        <div class="info-section">
                            ...
                            <p class="info-value">
                                ...
                                {{ $programKerja->created_at->format('d F Y, H:i') }}
                            </p>
                        </div>
                        ...
                        @if ($programKerja->updated_at != $programKerja->created_at)
                            <div class="info-section">
                                ...
                                <p class="info-value">
                                    ...
                                    {{ $programKerja->updated_at->format('d F Y, H:i') }}
                                </p>
                            </div>
                        @endif
                    </div>
