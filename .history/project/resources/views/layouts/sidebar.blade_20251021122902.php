<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
    <div class="pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('profil-organisasi.index') }}"
                    class="nav-link {{ request()->routeIs('profil-organisasi.*') ? 'active' : '' }}">
                    <i class="bi bi-building me-2"></i> Profil Organisasi
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('tentang-kami.index') }}"
                    class="nav-link {{ request()->routeIs('tentang-kami.*') ? 'active' : '' }}">
                    <i class="bi bi-info-circle-fill me-2"></i> Tentang Kami
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('pengaturan-web.index') }}"
                    class="nav-link {{ request()->routeIs('pengaturan-web.*') ? 'active' : '' }}">
                    <i class="bi bi-gear-fill me-2"></i> Pengaturan Web
                </a>
            </li>
        </ul>
    </div>
