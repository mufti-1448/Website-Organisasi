<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
    <div class="pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('program_kerja.index') }}" class="nav-link {{ request()->routeIs('program_kerja.*') ? 'active' : '' }}">
                    <i class="bi bi-clipboard-check-fill me-2"></i> Program Kerja
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('notulen.index') }}" class="nav-link {{ request()->routeIs('notulen.*') ? 'active' : '' }}">
