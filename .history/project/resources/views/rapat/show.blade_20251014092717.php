...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <p><strong>Tanggal:</strong> {{ $rapat->tanggal->format('d F Y') }}</p>
            ...
            {{-- Jumlah Peserta --}}
            <p><strong>Jumlah Peserta:</strong> {{ $rapat->peserta->count() ?? '-' }}</p>

            {{-- Tombol Aksi --}}
            <div class="mt-3">
                <a href="{{ route('rapat.index') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
                <a href="{{ route('rapat.edit', $rapat->id) }}" class="btn btn-outline-primary btn-sm">
                    <i class="bi bi-pencil-square"></i> Edit Rapat
                </a>
            </div>
        </div>
    </div>
