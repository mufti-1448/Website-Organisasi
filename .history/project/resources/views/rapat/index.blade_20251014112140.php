...
<div class="container mt-4">
    <h3><i class="bi bi-calendar-event"></i> Daftar Rapat</h3>
    ...
    <div class="mb-3">
        <a href="{{ route('rapat.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Tambah Rapat</a>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <form action="{{ route('rapat.destroy',$item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus?')">
                        @csrf
                        @method('DELETE')
