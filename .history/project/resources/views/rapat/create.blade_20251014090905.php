...
@section('content')
    ...
    <select name="keterangan" id="keterangan" class="form-select" required>
        ...
        <option value="Belum Dimulai" {{ old('keterangan', $rapat->keterangan ?? '') == 'Belum Dimulai' ? 'selected' : '' }}>Belum Dimulai</option>
        <option value="Sedang Berlangsung" {{ old('keterangan', $rapat->keterangan ?? '') == 'Sedang Berlangsung' ? 'selected' : '' }}>Sedang Berlangsung</option>
        <option value="Selesai" {{ old('keterangan', $rapat->keterangan ?? '') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
    </select>
</div>
