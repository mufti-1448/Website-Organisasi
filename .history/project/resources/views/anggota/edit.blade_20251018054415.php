            ...
            <form action="{{ route('anggota.update', $anggota->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('kelas') is-invalid @enderror" id="kelas"
                        ...
                        <option value="X PPLG 1" {{ old('kelas', $anggota->kelas) == 'X PPLG 1' ? 'selected' : '' }}>X PPLG 1</option>
                        <option value="X PPLG 2" {{ old('kelas', $anggota->kelas) == 'X PPLG 2' ? 'selected' : '' }}>X PPLG 2</option>
                        <option value="XI PPLG 1" {{ old('kelas', $anggota->kelas) == 'XI PPLG 1' ? 'selected' : '' }}>XI PPLG 1</option>
                        <option value="XI PPLG 2" {{ old('kelas', $anggota->kelas) == 'XI PPLG 2' ? 'selected' : '' }}>XI PPLG 2</option>
                        <option value="XII PPLG 1" {{ old('kelas', $anggota->kelas) == 'XII PPLG 1' ? 'selected' : '' }}>XII PPLG 1</option>
                        <option value="XII PPLG 2" {{ old('kelas', $anggota->kelas) == 'XII PPLG 2' ? 'selected' : '' }}>XII PPLG 2</option>
                    </select>
                    @error('kelas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                        ...
                        <option value="Koordinator" {{ old('jabatan', $anggota->jabatan) == 'Koordinator' ? 'selected' : '' }}>Koordinator</option>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">
                        ...
                        @if ($anggota->foto)
                            <br>Foto saat ini: <img src="{{ asset('uploads/anggota/' . $anggota->foto) }}"
