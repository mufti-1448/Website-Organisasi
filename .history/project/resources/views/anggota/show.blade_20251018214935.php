        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 text-center">
                    @if ($anggota->foto)
                        <img src="{{ asset('storage/uploads/anggota/' . $anggota->foto) }}" alt="Foto {{ $anggota->nama }}"
                ...
                <div class="col-md-8">
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            {{ $anggota->created_at ? $anggota->created_at->format('d M Y, H:i') : 'Tidak tersedia' }}</dd>

                        <dt class="col-sm-3">Diupdate</dt>
                        <dd class="col-sm-9">
                            {{ $anggota->updated_at ? $anggota->updated_at->format('d M Y, H:i') : 'Tidak tersedia' }}</dd>
                    </dl>
                </div>
            </div>
        </div>
