                    ...
                    <tbody>
                        @forelse($anggota as $item)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#showModal{{ $item->id }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            @if ($item->foto)
                                <img src="{{ asset('storage/uploads/anggota/' . $item->foto) }}" alt="Foto {{ $item->nama }}"
                        ...
                        <div class="col-md-8">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">
                                    {{ $item->created_at ? $item->created_at->format('d M Y, H:i') : 'Tidak tersedia' }}</dd>

                                <dt class="col-sm-4">Diupdate</dt>
                                <dd class="col-sm-8">
                                    {{ $item->updated_at ? $item->updated_at->format('d M Y, H:i') : 'Tidak tersedia' }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
