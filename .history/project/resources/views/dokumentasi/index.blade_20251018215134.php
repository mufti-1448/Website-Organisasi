        ...
        <tbody>
            @forelse ($dokumentasis as $index => $item)
                <tr>
                    ...
                    <td>
                        @if($item->foto)
<img src="{{ asset('storage/' . $dokumentasi->foto) }}" alt="Foto Dokumentasi" style="max-width: 200px;" class="img-thumbnail"></p>                        @else
                            -
                        @endif
                    </td>
                    <td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="showModalLabel{{ $item->id }}">Detail Dokumentasi - {{ $item->judul }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        @if($item->foto)
                            <img src="{{ asset('storage/dokumentasi/' . $item->foto) }}" class="img-fluid rounded shadow-sm" alt="Foto Dokumentasi" style="max-width: 400px; max-height: 300px;">
                        @else
