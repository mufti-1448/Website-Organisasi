...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mt-3">
        <div class="card-body">
            ...
            <p><strong>Program Kerja:</strong> {{ $dokumentasi->programKerja->nama ?? '-' }}</p>
            <p><strong>Rapat:</strong> {{ $dokumentasi->rapat->judul ?? '-' }}</p>
            <p><strong>Deskripsi:</strong><br>{{ $dokumentasi->deskripsi ?? '-' }}</p>

            <div class="mt-3">
                <img src="{{ asset('storage/' . $dokumentasi->foto) }}" class="img-fluid rounded shadow">
            </div>
