    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-striped align-middle" id="anggotaTable" style="border-radius: 0.375rem; overflow: hidden;">
                    ...
                    <tbody>
                        @forelse($anggota as $item)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $item->jabatan == 'Ketua' ? 'success' : ($item->jabatan == 'Wakil Ketua' ? 'info' : 'warning') }}">
                                        {{ $item->jabatan }}
                                    </span>
                                </td>
                                <td>{{ $item->kontak }}</td>
