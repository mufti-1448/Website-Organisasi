...
@section('content')
                        ...
                        @foreach ($kontak as $k)
                            <tr>
                                ...
                                <td class="text-center btn-action">
                                    <a href="{{ route('admin.kontak.show', $k->id) }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.kontak.reply', $k->id) }}" class="btn btn-sm btn-warning">
    ...
    <form action="{{ route('admin.kontak.updateSosial') }}" method="POST">
        @csrf
        ...
        <div class="row g-4">
            @php
                $platforms = [
                    ...
                    'linkedin' => ['label' => 'LinkedIn', 'icon' => 'linkedin text-primary'],
                    'youtube' => ['label' => 'YouTube', 'icon' => 'youtube text-danger'],
                    'tiktok' => ['label' => 'TikTok', 'icon' => 'tiktok text-dark'],
                    'whatsapp' => ['label' => 'WhatsApp', 'icon' => 'whatsapp text-success'],
                ];
            @endphp
