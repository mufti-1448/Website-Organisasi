...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="detail-container">
                ...
                <div class="row g-3">
                    ...
                    @if ($pesan->reply)
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" value="{{ $pesan->replied_at ? $pesan->replied_at->format('Y-m-d\TH:i') : '' }}" readonly>
                        </div>
                    @endif
                </div>
            </form>
            ...
            <div class="gap-3">
                <a href="{{ route('kontak.index') }}" class="btn btn-secondary mt-3"><i class="bi bi-arrow-left"></i> Kembali</a>
                <a href="{{ route('kontak.reply', $pesan->id) }}" class="btn btn-primary mt-3"><i class="bi bi-reply"></i> Balas</a>
            </div>
        </div>
    </div>
@endsection
