...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('notulen.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn- mt-3"><i class="bi bi-save"></i> Simpan</button>
            <a href="{{ route('notulen.index') }}" class="btn btn-secondary mt-3"><i class="bi bi-arrow-left"></i> Batal</a>
        </form>
    </div>
@endsection
