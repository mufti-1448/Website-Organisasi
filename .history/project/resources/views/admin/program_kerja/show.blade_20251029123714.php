                    ...
                    <div class="tab-pane fade" id="dokumentasi">
                        @if ($p->dokumentasi)
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $p->dokumentasi->judul }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" value="{{ $p->dokumentasi->tanggal }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Kategori</label>
                                <input type="text" class="form-control" value="{{ $p->dokumentasi->kategori ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
