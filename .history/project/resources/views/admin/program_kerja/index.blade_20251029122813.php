                        ...
                        @foreach ($programKerja as $p)
                            <tr>
                                ...
                                <td class="text-center btn-action">
                                    <a href="{{ route('program_kerja.show', $p->id) }}" class="btn btn-sm btn-info"><i
                                            class="bi bi-eye"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-sm">
                                                ...
                                                <div class="modal-footer border-0 justify-content-center pb-4 gap-2">
                                                    ...
                                                    <form action="{{ route('program_kerja.destroy', $p->id) }}"
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-section">
                                ...
                                @forelse ($p->notulen as $n)
                                    <a href="{{ asset('storage/' . $n->file_path) }}" target="_blank">📄 Lihat
                                        Notulen</a><br>
                                @empty
                        ...
                        <div class="modal-footer border-0">
                            ...
                            <a href="{{ route('program_kerja.edit', $p->id) }}" class="btn btn-warning">
