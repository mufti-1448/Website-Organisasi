            ...
            <form>
                ...
                <div class="tab-content mt-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $p->penanggungJawab->nama ?? '-' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Target Date</label>
                                <input type="date" class="form-control" value="{{ $p->target_date }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Status</label>
                                <input type="text" class="form-control" value="{{ ucfirst($p->status) }}" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" rows="5" readonly>{{ $p->deskripsi ?? '-' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="notulen">
                        ...
                        @empty
                            <p class="text-muted">Belum ada notulen untuk p kerja ini.</p>
                        @endforelse
                    </div>
                    ...
                    <div class="tab-pane fade" id="dokumentasi">
                        @if ($p->dokumentasi)
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $p->dokumentasi->judul }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" rows="3" readonly>{{ $p->dokumentasi->deskripsi ?? '-' }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tanggal</label>
                                <input type="date" class="form-control" value="{{ $p->dokumentasi->tanggal }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Kategori</label>
                                <input type="text" class="form-control"
                                    value="{{ $p->dokumentasi->kategori ?? '-' }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Foto</label>
                                @if ($p->dokumentasi->foto)
                                    <br>
                                    <img src="{{ asset('storage/' . $p->dokumentasi->foto) }}" class="img-thumbnail"
                        ...
                        @else
                            <p class="text-muted">Belum ada dokumentasi untuk p ini.</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="evaluasi">
                    ...
                    @empty
                        <p class="text-muted">Belum ada evaluasi untuk p kerja ini.</p>
                    @endforelse
                </div>
        </div>
        </form>
