            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    @forelse ($p->notulen as $n)
                        <a href="{{ asset('storage/' . $n->file_path) }}" target="_blank" class="d-block text-decoration-none">
                            📄 Lihat Notulen
                        </a>
                    @empty
                            ...
                            @if ($d->foto)
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $d->foto) }}" 
                                        class="rounded border" style="width: 100px; height: 80px; object-fit: cover;">
                ...
                <div>
                    ...
                    @forelse ($p->evaluasi as $e)
                        <a href="{{ asset('storage/' . $e->file) }}" target="_blank" class="d-block text-decoration-none">
                            📄 Lihat Evaluasi
                        </a>
                    @empty
