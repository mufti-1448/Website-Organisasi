                    ...
                    <div class="tab-pane fade" id="dokumentasi">
                        @if ($program->dokumentasi)
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $program->dokumentasi->nama }}"
                                    readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deskripsi</label>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($program->dokumentasi->foto)
                                    <br>
                                    <img src="{{ asset('storage/' . $program->dokumentasi->foto) }}" class="img-thumbnail"
                        ...
                        @else
                            <p class="text-muted">Belum ada dokumentasi untuk program ini.</p>
                        @endif
                    </div>
                </div>
