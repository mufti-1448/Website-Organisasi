                ...
                <div class="col-lg-8 mx-auto">
                    <div class="info-card">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $user['email'] ?? 'admin@sistemorganisasi.com' }}</span>
                        </div>

                        <div class="info-item">
                            <span class="info-label">Bergabung Sejak:</span>
                            <span
                                class="info-value">{{ isset($user['created_at']) ? $user['created_at']->format('d M Y') : '30 Nov 2024' }}</span>
                        </div>

                        <div class="info-item">
                            <span class="info-label">Terakhir Login:</span>
                            <span
                                class="info-value">{{ isset($user['updated_at']) ? $user['updated_at']->format('d M Y, H:i') : now()->format('d M Y, H:i') }}</span>
                        </div>
                    </div>
