    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->status }}</td>
                <td>
                    <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewModal" onclick="viewRapat('{{ $item->id }}')"><i class="bi bi-eye"></i></button>
...
function viewRapat(id) {
    fetch(`/rapat/${id}`)
        ...
        .catch(error => {
            ...
            document.getElementById('modalContent').innerHTML = '<p class="text-danger">Terjadi kesalahan saat memuat data.</p>';
        });
}
</script>
@endsection
