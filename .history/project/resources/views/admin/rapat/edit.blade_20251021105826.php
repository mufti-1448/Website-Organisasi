                ...
                <div class="mb-3">
                    ...
                    <select name="dokumentasi_id" class="form-select">
                        ...
                        @foreach($dokumentasiList as $dokumentasi)
                            <option value="{{ $dokumentasi->id }}" {{ $rapat->dokumentasi && $rapat->dokumentasi->id == $dokumentasi->id ? 'selected' : '' }}>
                                {{ $dokumentasi->judul }} ({{ \Carbon\Carbon::parse($dokumentasi->tanggal)->format('d-m-Y') }})
                            </option>
                        @endforeach
                    </select>
                </div>
