        ...
        $(document).ready(function() {
            $('#rapatTable').DataTable({
                ...
                "columnDefs": [{
                        "orderable": false,
                        "targets": [0, 7]
                    } // Disable sorting on No and Aksi columns
                ],
                "initComplete": function() {
                    // Check if table has no data rows
                    if ($('#rapatTable tbody tr').length === 0) {
                        $('#rapatTable tbody').append(
                            '<tr><td class="text-center text-muted" colspan="8">Belum ada rapat.</td></tr>'
                            );
                    }
                }
            });
