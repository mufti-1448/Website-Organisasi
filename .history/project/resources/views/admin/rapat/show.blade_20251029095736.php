                    ...
                    @if ($rapat->notulen)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="{{ $rapat->notulen->penulis->nama ?? '-' }}" readonly>
                            </div>
                        </div>
                    @else
                ...
                <div class="tab-pane fade" id="dokumentasi">
                    @if ($rapat->dokumentasi)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $rapat->dokumentasi->kategori ?? '-' }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Foto</label>
                            @if ($rapat->dokumentasi->foto)
                                <br>
                                <img src="{{ asset('storage/' . $rapat->dokumentasi->foto) }}" class="img-thumbnail" style="max-width: 230px;">
                            @else
