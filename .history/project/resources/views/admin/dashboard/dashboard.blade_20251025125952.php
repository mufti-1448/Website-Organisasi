        ...
        <div class="row g-3 mb-4">
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-primary shadow-sm">
                    ...
                    <div class="card-footer bg-transparent border-0 p-2 d-flex justify-content-end">
                        <a class="text-muted text-decoration-none" href="{{ route('anggota.index') }}">
                            Lihat data
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-success shadow-sm">
                    ...
                    <div class="card-footer bg-transparent border-0 p-2 d-flex justify-content-end">
                        <a class="text-muted text-decoration-none" href="{{ route('rapat.index') }}">
                            Lihat data
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi" viewBox="0 0 16 16" aria-hidden="true">
                                <path
                                    d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-warning shadow-sm">
                    ...
                    <div class="card-footer bg-transparent border-0 p-2 d-flex justify-content-end">
                        <a class="text-muted text-decoration-none" href="{{ route('program_kerja.index') }}">
                            Lihat data
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi" viewBox="0 0 16 16" aria-hidden="true">
                                <path
                                    d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-info shadow-sm">
                    ...
                    <div class="card-footer bg-transparent border-0 p-2 d-flex justify-content-end">
                        <a class="text-muted text-decoration-none" href="{{ route('evaluasi.index') }}">
                            Lihat data
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi" viewBox="0 0 16 16" aria-hidden="true">
                                <path
                </div>
