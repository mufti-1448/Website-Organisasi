...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="card stat-card border-start-primary shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="text-muted d-flex align-items-center justify-content-center"
                             style="width:56px; height:56px; border-radius:12px; background: rgba(78,115,223,0.08);">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-success shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="text-muted d-flex align-items-center justify-content-center"
                             style="width:56px; height:56px; border-radius:12px; background: rgba(28,200,138,0.08);">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-warning shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="text-muted d-flex align-items-center justify-content-center"
                             style="width:56px; height:56px; border-radius:12px; background: rgba(246,194,62,0.08);">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="card stat-card border-start-info shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="text-muted d-flex align-items-center justify-content-center"
                             style="width:56px; height:56px; border-radius:12px; background: rgba(54,185,204,0.08);">
        ...
        {{-- Rapat Terbaru & Program Kerja Terbaru (dua kolom) --}}
        <div class="row g-3">
            <!-- Rapat Terbaru -->
            <div class="col-lg-6">
                                        ...
                                        <div class="d-flex align-items-start justify-content-between">
                                            ...
                                            <div class="ms-3">
                                                @if(\Carbon\Carbon::parse($rapat->tanggal)->isPast())
                                                    <span class="status-pill" style="background:#ecfdf5; color:#16a34a;">
                                                        Selesai
                                                    </span>
                                                @else
                                                    <span class="status-pill" style="background:#fff7ed; color:#d97706;">
                                                        Mendatang
                                                    </span>
                                                @endif
                                            </div>
                ...
                <div class="card card-clean h-100">
                    <div class="card-body d-flex flex-column">
                        <div class="card-header-mini">
                            ...
                            <a href="{{ route('program_kerja.index') }}" class="small text-primary">Lihat Semua</a>
                        </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <div class="program-target">
                                                        Target: {{ \Carbon\Carbon::parse($program->target_date ?? now())->translatedFormat('j F Y') }}
                                                    </div>
                                                </div>
