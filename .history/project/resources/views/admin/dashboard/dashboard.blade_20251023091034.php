        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        @if ($rapatTerbaru->isEmpty())
                            <p class="text-muted">Tidak ada data rapat terbaru.</p>
                        @else
                            <ul class="list-group">
                                @foreach ($rapatTerbaru as $rapat)
                                    <li class="list-group-item">
                                        <h6 class="mb-1">{{ $rapat->judul }}</h6>
                                        <small class="text-muted">
                                            Tanggal: {{ $rapat->tanggal }} | Lokasi: {{ $rapat->lokasi }}
                                        </small>
                                    </li>
                                @endforeach
                            </ul>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        @if ($programTerbaru->isEmpty())
                            <p class="text-muted">Tidak ada data program kerja terbaru.</p>
                        @else
                            <ul class="list-group">
                                @foreach ($programTerbaru as $program)
                                    <li class="list-group-item">
                                        ...
                                        <small class="text-muted">
                                            Tanggal Mulai: {{ $program->tanggal_mulai }} | Status: {{ ucfirst($program->status) }}
                                        </small>
                                    </li>
