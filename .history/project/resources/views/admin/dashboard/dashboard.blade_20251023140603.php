...
@section('content')
    ...
    border-left: 5px solid transparent; /* hanya di kiri */
    border-radius: 8px;
    transition: transform 0.2s ease, box-shadow 0.2s ease;
}

.border-start-primary {
    border-left-color: #4e73df; /* biru */
}

.border-start-success {
    border-left-color: #1cc88a; /* hijau */
}

.border-start-warning {
    border-left-color: #f6c23e; /* kuning */
}

.border-start-info {
    border-left-color: #36b9cc; /* biru muda */
}
