            ...
            <div class="col-xl-4 col-lg-5 mb-4">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        @if ($rapataTerbaru->isEmpty() && $programTerbaru->isEmpty())
                            <div class="alert alert-info">Belum Ada Aktivitas Terbaru</div>
                        @endif

                        @@foreach ($collection as $item)
                            
                        @endforeach($rapatTerbaru->take(3) as $rapat)
                        ...
                        @empty
                            <div class="alert alert-info">Belum Ada Rapat Terbaru</div>
                        @endforelse
                        ...
                        @empty
                            <div class="alert alert-info">Belum Ada Program Kerja Terbaru</div>
                        @endforelse
                    </div>
                </div>
            </div>
