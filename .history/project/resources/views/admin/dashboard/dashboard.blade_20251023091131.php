              ...
              <div class="flex-grow-1">
                <div class="d-flex align-items-start justify-content-between">
                  <div>
                    ...
                    <div class="item-date">
                      {{ \Carbon\Carbon::parse($rapat->tanggal)->translatedFormat('j F Y') }} • {{ \Carbon\Carbon::parse($rapat->tanggal)->format('H:i') }} WIB
                    </div>
                  </div>
                  <!-- badge status -->
                  <div class="ms-3">
                ...
                <div class="flex-grow-1">
                  ...
                  <div class="progress-thin mt-2">
                    <div class="progress-bar
                      ...
                      @else bg-danger
                      @endif" role="progressbar" style="width: {{ $progress }}%;" aria-valuenow="{{ $progress }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
