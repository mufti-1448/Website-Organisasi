...
@section('content')
    <style>
        <style>
    .doc-card {
        border: 1px solid #e0e0e0; /* border tipis biar keliatan */
        border-left: 4px solid #0d6efd; /* highlight kiri biar elegan */
        transition: all 0.2s ease-in-out;
    }

    .doc-card:hover {
        transform: translateY(-4px);
        box-shadow: 0 6px 20px rgba(0,0,0,0.15); /* shadow lebih kuat */
    }
