                        ...
                        @foreach ($evaluasi as $index => $item)
                            <tr>
                                ...
                                <td class="text-center btn-action">
                                    ...
                                    <a href="{{ route('evaluasi.show', $item->id) }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow-sm">
                                                ...
                                                <div class="modal-body text-center text-muted">
                                                    Data <strong>{{ $->nama }}</strong> akan dihapus secara permanen.
                                                </div>
                                                ...
                                                <div class="modal-footer border-0 justify-content-center pb-4 gap-2">
                                                    ...
                                                    <form action="{{ route('anggota.destroy', $p->id) }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
