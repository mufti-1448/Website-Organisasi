...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="detail-container">
                    ...
                    <div class="tab-pane fade show active" id="detail">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $evaluasi->penulis }}" readonly>
                            </div>
                            <div class="col-md-12">
            ...
            <div class="gap-3">
                <a href="{{ route('evaluai.index') }}" class="btn btn-secondary mt-3"><i class="bi bi-arrow-left"></i>
                    Kembali</a>
                <a href="{{ route('notulen.edit', $notulen->id) }}" class="btn btn-warning mt-3"><i class="bi bi-pencil"></i>
                    Edit
                </a>
            </div>
        </div>
