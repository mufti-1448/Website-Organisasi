            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card p-3">
                        ...
                        <p><strong>Status:</strong> <span class="badge bg-info text-dark">{{ ucfirst($p->status) }}</span></p>
                    </div>
                    ...
                    @forelse ($p->dokumentasi as $d)
                        @if($d->foto)
                            <div class="mb-3">
                                <img src="{{ asset('storage/uploads/dokumentasi/' . $d->foto) }}" alt="Dokumentasi" class="img-fluid" style="max-width: 300px;">
