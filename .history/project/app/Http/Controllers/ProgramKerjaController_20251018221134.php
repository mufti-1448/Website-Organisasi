...
class ProgramKerjaController extends Controller
{
    ...
    {
        $program = ProgramKerja::with(['penanggungJawab', 'notulen', 'evaluasi', 'dokumentasi'])->findOrFail($id);
    ...
    public function edit(string $id)
    {
        ...
        return view('program_kerja.edit', compact('program', 'anggota', 'notulenList', 'evaluasiList', 'dokumentasiList'));
    }
